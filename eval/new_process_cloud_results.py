...
def load_data(cloud_api, dataset_name):
    if cloud_api == 'label':
        query1 = 'Label'
        query2 = 'Score'
        file = 'temp_cloud_results_labels'
    elif cloud_api == 'text':
        query1 = 'Text'
        query2 = 'Bounds'
        file = 'temp_cloud_results_text'
    df_data = {'File': [], 'Dataset': [], 'Parameter': [], 'Mode': [], query1: [], query2: []}
    # parameters = ['pixelate-1-8', 'pixelate-1-16', 'pixelate-1-24', 'pixelate-1-32', 'pixelate-2-8', 'pixelate-2-16', 'pixelate-2-24', 'pixelate-2-32', 'pixelate-3-8', 'pixelate-3-16', 'pixelate-3-24', 'pixelate-3-32', 'pixelate-4-8', 'pixelate-4-16', 'pixelate-4-24', 'pixelate-4-32', 'blur-1-8', 'blur-1-16', 'blur-1-24', 'blur-1-32', 'blur-2-8', 'blur-2-16', 'blur-2-24', 'blur-2-32', 'blur-3-8', 'blur-3-16', 'blur-3-24', 'blur-3-32', 'blur-4-8', 'blur-4-16', 'blur-4-24', 'blur-4-32']
    parameters = ['pixelate-1-16', 'pixelate-1-32', 'pixelate-2-16', 'pixelate-2-32', 'pixelate-3-16', 'pixelate-3-32', 'pixelate-4-16', 'pixelate-4-32', 'blur-1-8', 'blur-1-16', 'blur-2-8', 'blur-2-16', 'blur-3-8', 'blur-3-16', 'blur-4-8', 'blur-4-16']
...
def run_labels(dataset_name):
    ...
    temp_df = df.where(df['Parameter'].isin(['pixelate-1-16', 'pixelate-2-16', 'pixelate-3-16', 'pixelate-4-16', 'blur-1-16', 'blur-2-16', 'blur-3-16', 'blur-4-16']))
    ...
    # plt.tight_layout()
    # sns.despine()
    # plt.savefig(os.path.join('data/plots', 'google_cloud_labels_param_{}.pdf'.format(dataset_name)))
